...
<main>
    ...
    <section class="breadcrumb__area" style="background-image: url('<?php echo e(asset('front/assets/imgs/aboutBd.jpg')); ?>');">
        <div class="container">
            <div class="row">
    ...
    <section class="about__area-6 pt-150 pb-150">
        <div class="container">
            <div class="row">
                <div class="col-xxl-6 col-xl-6 col-xl-6 col-md-6">
                    <div class="main-img">
                        <img class="m-0" data-aos="fade-right" data-aos-delay="100" src="<?php echo e(asset('front/assets/imgs/aboutMission.jpg')); ?>" alt="Image">
                    </div>
                </div>
                <div class="col-xxl-6 col-xl-6 col-xl-6 col-md-6">
        ...
        <img src="<?php echo e(asset('front/assets/imgs/shape/6.png')); ?>" alt="Zigzag Shape" class="shape">
    </section>
    <!-- About area end -->
    <!-- Counter area start -->
            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="counter__inner">
                        ...
                        <div class="counter__item">
                            <div class="counter__number counter_slow underline-5">100+ <span>100+</span></div>
                            <h3 class="counter__title underline-2">Range of <br> Products</h3>
                        </div>
                        <div class="counter__item">
                            <div class="counter__number counter_slow underline-5">200+ <span>200+</span></div>
                            <h3 class="counter__title underline-2">Happy <br> Customers</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6">
                    <div class="who__right">
                        <div class="main-img">
                            <img class="m-0" data-aos="fade-up" data-aos-delay="100" src="<?php echo e(asset('front/assets/imgs/mision.jpg')); ?>" alt="Image">
                        </div>
                        <img src="<?php echo e(asset('front/assets/imgs/shape/7.png')); ?>" alt="Shape" class="shape">
                        <img src="<?php echo e(asset('front/assets/imgs/shape/12.png')); ?>" alt="Shape" class="shape-2">
                        <img src="<?php echo e(asset('front/assets/imgs/shape/13.png')); ?>" alt="Shape" class="shape-3">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('front.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rtpltechin/nneworld.rtpltech.in/resources/views/front/pages/aboutus/aboutus.blade.php ENDPATH**/ ?>