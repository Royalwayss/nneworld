...
<main>
    ...
    <section class="breadcrumb__area" style="background-image: url('<?php echo e(asset('front/assets/imgs/privacyBd.jpg')); ?>');">
        <div class="container">
            <div class="row">
    ...
    <section class="contact__area-6 pt-100 pb-150">
        <div class="container policies">
            ...
            <p>At NNE World, accessible from <a href="https://navyugbicycle.in/.">Navyug Bicycle</a>, one of our main
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in NNE World. This policy is not applicable
            ...
            <h2 class="projectd__details-title-3">Consent</h2>
            <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>
            <h2 class="projectd__details-title-3">Information we collect</h2>
            ...
            <h2 class="projectd__details-title-3">How we use your information</h2>
            ...
            <h2 class="projectd__details-title-3">Log Files</h2>
            <p>NNE World follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <h2 class="projectd__details-title-3">Cookies and Web Beacons</h2>
            <p>Like any other website, NNE World uses ‘cookies’. These cookies are used to store information including
            ...
            <h2 class="projectd__details-title-3">Advertising Partners Privacy Policies</h2>
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of NNE World.
            </p>
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on NNE World, which are sent directly to
            ...
            <p>Note that NNE World has no access to or control over these cookies that are used by third-party
                advertisers.</p>
            <h2 class="projectd__details-title-3">Third Party Privacy Policies</h2>
            <p>NNE World’s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <h2 class="projectd__details-title-3">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
            ...
            <h2 class="projectd__details-title-3">GDPR Data Protection Rights</h2>
            ...
            <h2 class="projectd__details-title-3">Children’s Information</h2>
            ...
            <p>NNE World does not knowingly collect any Personal Identifiable Information from children under the age of
...
<?php echo $__env->make('front.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rtpltechin/nneworld.rtpltech.in/resources/views/front/pages/cms/privacy-policy.blade.php ENDPATH**/ ?>