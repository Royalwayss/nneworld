      ...
      <link rel="stylesheet" href="{{ asset('front/assets/css/master.css') }}?v=2.7">
      <link rel="stylesheet" href="{{ asset('front/assets/css/responsive.css') }}?v=2.7">
      <link rel="stylesheet" href="{{ asset('front/assets/css/custom.css') }}?v=2.6">