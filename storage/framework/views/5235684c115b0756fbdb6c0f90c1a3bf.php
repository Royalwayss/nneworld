...
<main>
    ...
    <section class="breadcrumb__area" style="background-image: url('<?php echo e(asset('front/assets/imgs/processBd.jpg')); ?>');">
        <div class="container">
            <div class="row">
...
<?php echo $__env->make('front.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rtpltechin/nneworld.rtpltech.in/resources/views/front/pages/aboutus/processes.blade.php ENDPATH**/ ?>