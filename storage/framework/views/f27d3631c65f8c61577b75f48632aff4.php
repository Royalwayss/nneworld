               ...
               <div class="col-xxl-6 col-xl-6 col-xl-6 col-md-6">
                  <div class="about__content">
                     ...
                     <div data-aos="fade-up" data-aos-delay="300">
                        <a class="db-btn-arrow" href="<?php echo e(route('aboutus')); ?>">More Info <i class="fa-solid fa-arrow-right"></i>
                        </a>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               ...
               <div class="col-xxl-7 col-xl-7 col-lg-7">
                  <div class="newsletter__right ps-xxl-5">
                     <form action="javascript:;" data-action="<?php echo e(route('addsubscriber')); ?>" class="ps-xxl-5" id="newsletter-form"><?php echo csrf_field(); ?>
...
<?php echo $__env->make('front.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rtpltechin/nneworld.rtpltech.in/resources/views/front/pages/home/index.blade.php ENDPATH**/ ?>