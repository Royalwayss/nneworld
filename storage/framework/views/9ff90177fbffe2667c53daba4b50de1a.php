...
<main>
    ...
    <section class="breadcrumb__area" style="background-image: url('<?php echo e(asset('front/assets/imgs/termsBd.jpg')); ?>');">
        <div class="container">
            <div class="row">
    ...
    <section class="contact__area-6 pt-100 pb-150">
        <div class="container policies">
            <h2 class="projectd__details-title mb-3">Welcome to NNE World!</h2>
            <p>These terms and conditions outline the rules and regulations for the use of Navyug Namdhari Ecodrive
                Private Limited’s Website, located at <a href="https://navyugbicycle.in/.">Navyug Bicycle</a>.</p>
            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use NNE
                World if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <h2 class="projectd__details-title-3">Cookies</h2>
            <p>We employ the use of cookies. By accessing NNE World, you agreed to use cookies in agreement with the
                Navyug Namdhari Ecodrive Private Limited’s Privacy Policy.</p>
            ...
            <h2 class="projectd__details-title-3">License</h2>
            <p>Unless otherwise stated, Navyug Namdhari Ecodrive Private Limited and/or its licensors own the
                intellectual property rights for all material on NNE World. All intellectual property rights are
                reserved. You may access this from NNE World for your own personal use subjected to restrictions set in
                these terms and conditions.</p>
            <p>You must not:</p>
            <ul>
                <li>Republish material from NNE World</li>
                <li>Sell, rent or sub-license material from NNE World</li>
                <li>Reproduce, duplicate or copy material from NNE World</li>
                <li>Redistribute content from NNE World</li>
            </ul>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. Navyug Namdhari Ecodrive Private Limited does not filter, edit, publish or
                review Comments prior to their presence on the website. Comments do not reflect the views and opinions
                of Navyug Namdhari Ecodrive Private Limited,its agents and/or affiliates. Comments reflect the views and
                opinions of the person who post their views and opinions. To the extent permitted by applicable laws,
                Navyug Namdhari Ecodrive Private Limited shall not be liable for the Comments or for any liability,
            ...
            <p>Navyug Namdhari Ecodrive Private Limited reserves the right to monitor all Comments and to remove any
            ...
            <p>You hereby grant Navyug Namdhari Ecodrive Private Limited a non-exclusive license to use, reproduce, edit
                and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or
                media.</p>
            <h2 class="projectd__details-title-3">Hyperlinking to our Content</h2>
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of Navyug Namdhari Ecodrive Private Limited; and (d) the link is in the context of general
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to Navyug Namdhari Ecodrive Private Limited. Please
            ...
            <p>No use of Navyug Namdhari Ecodrive Private Limited’s logo or other artwork will be allowed for linking
                absent a trademark license agreement.</p>
            <h2 class="projectd__details-title-3">iFrames</h2>
            ...
            <h2 class="projectd__details-title-3">Content Liability</h2>
            ...
            <h2 class="projectd__details-title-3">Your Privacy</h2>
            <p>Please read <a href="privacy-policy.php">Privacy Policy</a></p>
            <h2 class="projectd__details-title-3">Reservation of Rights</h2>
            ...
            <h2 class="projectd__details-title-3">Removal of links from our website</h2>
            ...
            <h2 class="projectd__details-title-3">Disclaimer</h2>
...
<?php echo $__env->make('front.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rtpltechin/nneworld.rtpltech.in/resources/views/front/pages/cms/terms-and-conditions.blade.php ENDPATH**/ ?>