            ...
            <div class="col-12">
               ...
               <div class="card">
                  ...
                  <div class="card-header">
                     <a style="float:right" href="javascript:;" data-module="Add Product" data-href="<?php echo e(route('addeditproduct')); ?>" data-modal-type="wider" data-id="" class="btn btn-primary addedit-modal"><i class="fa fa-plus" aria-hidden="true"></i> Add Product</a>
                  </div>
                  <?php endif; ?>
                  <!-- /.card-header -->
                  <div class="card-body">
...
<script>
   ...
   $(document).on('click','.updateImageSort',function(){
          ...
          $.ajax({
              ...
              url : "<?php echo e(route('updateimagesort')); ?>",
              type : "get",
      ...
      $(document).on('click','.Deleteimage',function(){ 
   	...
   	$.ajax({
              data : {id:id},
              url : "<?php echo e(route('imagedelete')); ?>",
              type : "get",
              success:function(resp){
   			$("#delete-"+id).remove();
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rtpltechin/nneworld.rtpltech.in/resources/views/admin/products/products.blade.php ENDPATH**/ ?>