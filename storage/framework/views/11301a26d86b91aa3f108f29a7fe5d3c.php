          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <a style="float:right" href="javascript:;" data-module="Add Component" data-href="<?php echo e(route('addeditcomponent')); ?>" data-modal-type="small" data-id="" class="btn btn-primary addedit-modal"><i class="fa fa-plus" aria-hidden="true"></i> Add Component</a>
              </div>
              <?php endif; ?>
              <!-- /.card-header -->
              <div class="card-body">
...
<script>
 $(document ).ready(function() { 
    ...
    serverSide: true,
    ajax: {
        url: "<?php echo e(route('components')); ?>",
        data: function (d) {
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rtpltechin/nneworld.rtpltech.in/resources/views/admin/components/list.blade.php ENDPATH**/ ?>