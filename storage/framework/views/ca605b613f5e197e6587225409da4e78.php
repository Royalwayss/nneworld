...
<main>
    ...
    <section class="breadcrumb__area" style="background-image: url('<?php echo e(asset('front/assets/imgs/susBd.jpg')); ?>');">
        <div class="container">
            <div class="row">
        ...
        <div class="container sus">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 col-12 order-2 order-sm-1">
                    <div class="susImg">
                        <img data-aos="fade-right" src="<?php echo e(asset('front/assets/imgs/sustain-1.jpg')); ?>" alt="Image ">
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="susImg">
                        <img data-aos="fade-left" src="<?php echo e(asset('front/assets/imgs/sustain-2.jpg')); ?>" alt="Image ">
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 col-12 order-2 order-sm-1">
                    <div class="susImg">
                        <img data-aos="fade-right" src="<?php echo e(asset('front/assets/imgs/sustain-3.jpg')); ?>" alt="Image ">
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-12 order-1 order-sm-2">
                    <div class="about__content pt-0">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="susImg">
                        <img data-aos="fade-left" src="<?php echo e(asset('front/assets/imgs/sustain-4.jpg')); ?>" alt="Image ">
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 col-12 order-2 order-sm-1">
                    <div class="susImg">
                        <img data-aos="fade-right" src="<?php echo e(asset('front/assets/imgs/sustain-5.jpg')); ?>" alt="Image ">
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-12 order-1 order-sm-2">
                    <div class="about__content pt-0">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="susImg">
                        <img data-aos="fade-left" src="<?php echo e(asset('front/assets/imgs/sustain-6.jpg')); ?>" alt="Image ">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('front.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rtpltechin/nneworld.rtpltech.in/resources/views/front/pages/aboutus/sustainability.blade.php ENDPATH**/ ?>